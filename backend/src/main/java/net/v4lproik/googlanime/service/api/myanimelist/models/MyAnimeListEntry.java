...
public abstract class MyAnimeListEntry {
    ...
    protected List<MyAnimeListEntry> sequels = new ArrayList<MyAnimeListEntry>();

    protected List<MyAnimeListEntry> alternativeVersions = new ArrayList<MyAnimeListEntry>();

    protected List<MyAnimeListEntry> prequels = new ArrayList<MyAnimeListEntry>();

    protected List<MyAnimeListEntry> spinoff = new ArrayList<MyAnimeListEntry>();

    protected List<MyAnimeListEntry> sideStories = new ArrayList<MyAnimeListEntry>();

    protected List<MyAnimeListEntry> others = new ArrayList<MyAnimeListEntry>();

    protected List<MyAnimeListEntry> summaries = new ArrayList<MyAnimeListEntry>();

    protected List<MyAnimeListEntry> adaptations = new ArrayList<MyAnimeListEntry>();
